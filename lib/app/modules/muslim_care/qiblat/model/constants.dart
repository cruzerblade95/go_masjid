...
const kDarkBlue = Color(0xFF00006C);
...
const kTitleTextStyle = TextStyle(fontSize: 40, color: Colors.white, fontFamily: 'Courier New', decoration: TextDecoration.underline,);

const kEnTipsTextStyle = TextStyle(color: Colors.white, letterSpacing: 0.2, fontFamily: 'Courier New', height: 1.5);
const kArTipsTextStyle = TextStyle(color: Colors.white, letterSpacing: 1.5, fontFamily: 'Courier New', height: 1.5);
